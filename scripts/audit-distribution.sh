...
AGENT_PLIST_NAME="dev.jc.macalarm.agent.plist"
...
[[ "$bundle_id" == "dev.jc.macalarm" ]] || fail "Unexpected bundle id: $bundle_id"
...
[[ "$agent_label" == "dev.jc.macalarm.agent" ]] || fail "Unexpected agent label: $agent_label"

...
AGENT_PLIST_NAME="com.jctec.macalarm.agent.plist"
...
[[ "$bundle_id" == "com.jctec.macalarm" ]] || fail "Unexpected bundle id: $bundle_id"
...
[[ "$agent_label" == "com.jctec.macalarm.agent" ]] || fail "Unexpected agent label: $agent_label"
